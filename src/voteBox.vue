<template>
  <div class="m-10 grid grid-cols-10 text-white">
    <Avatar
      v-if="content.avatar"
      size="xlarge"
      class="p-avatar-circle mt-5"
      :image="content.avatar"
    ></Avatar>
    <Avatar v-else icon="pi pi-user" size="xlarge" class="p-avatar-circle mt-5"></Avatar>
    ...
    <div class="col-start-9 col-span-4 flex gap-3 m-5 text-light-100">
